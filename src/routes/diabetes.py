...
from src.database.database  import DiabetesProbabilityV3
from src.database.utils import get_db
from src.pydantic_models.request_models import InputRequestV3
...
model_dir = os.path.join(os.getcwd(),"src","ml_models","diabetes_probability_model_v3.model")
data = os.path.join(os.getcwd(),"src","data","lime_explainer_dataset.csv")
df = pd.read_csv(data)
